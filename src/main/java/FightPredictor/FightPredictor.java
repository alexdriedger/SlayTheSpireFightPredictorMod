...
import FightPredictor.relics.BottledPlaceholderRelic;
import FightPredictor.relics.DefaultClickableRelic;
import FightPredictor.relics.PlaceholderRelic;
import FightPredictor.relics.PlaceholderRelic2;
import FightPredictor.util.IDCheckDontTouchPls;
import FightPredictor.util.TextureLoader;
...
public class FightPredictor implements
    ...
    private static final String MODNAME = "Fight Predictor";
    ...
    public static void setModID(String ID) { // DON'T EDIT
        ...
        InputStream in = FightPredictor.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THIS ETHER
    ...
    private static void pathCheck() { // ALSO NO
        ...
        InputStream in = FightPredictor.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THISSSSS
        IDCheckDontTouchPls EXCEPTION_STRINGS = coolG.fromJson(new InputStreamReader(in, StandardCharsets.UTF_8), IDCheckDontTouchPls.class); // NAH, NO EDIT
        String packageName = FightPredictor.class.getPackage().getName(); // STILL NO EDIT ZONE
    ...
    public static void initialize() {
        ...
        FightPredictor defaultmod = new FightPredictor();
