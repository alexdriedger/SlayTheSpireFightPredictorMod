...
import FightPredictor.patches.relics.BottledPlaceholderField;
import FightPredictor.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static FightPredictor.FightPredictor.makeRelicOutlinePath;
import static FightPredictor.FightPredictor.makeRelicPath;
...
public class BottledPlaceholderRelic extends CustomRelic implements CustomBottleRelic, CustomSavable<Integer> {
    ...
    // ID, images, text.
    public static final String ID = FightPredictor.makeID("BottledPlaceholderRelic");
