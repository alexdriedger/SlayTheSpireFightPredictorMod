...
import static FightPredictor.FightPredictor.makePowerPath;
...
public class CommonPower extends AbstractPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = FightPredictor.makeID("CommonPower");
