...
public class ModelUtils {
    ...
    private static final int characterCount = 4;
    ...
    private static Map<String, Integer> characterEncoding;
    ...
    public static void init() {
        ...
        List<String> allCharacters = new ArrayList<>(Arrays.asList("DEFECT", "IRONCLAD", "THE_SILENT", "WATCHER"));

        cardEncoding = putEncodings(allCards);
        relicEncoding = putEncodings(allRelics);
        encounterEncoding = putEncodings(allEncounters);
        characterEncoding = putEncodings(allCharacters);
    ...
    public static float[] getInputVector(List<AbstractCard> masterDeck, List<AbstractRelic> masterRelics, String encounter,
        ...
        outputVector[characterEncoding.get(character) + cardCount + relicCount + encountersCount] += 1;

        int remainingOffset = cardCount + relicCount + encountersCount + characterCount;
        outputVector[remainingOffset] = maxHP;
        outputVector[remainingOffset + 1] = enteringHP;
        outputVector[remainingOffset + 2] = ascension;
        outputVector[remainingOffset + 3] = floor;
        outputVector[remainingOffset + 4] = potionUsed ? 1 : 0;
